...
public class ForeCastInflater  {
    public ForeCastInflater(LinearLayout linearLayout, LayoutInflater inflater, List<ForeCast> foreCasts, int i) {

        View view = inflater.inflate(R.layout.forecast_layout, linearLayout, false);
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd MMMM yyyy");
        String df = simpleDateFormat.format(new Date(foreCasts.get(i).getEpochdate()*1000));
        ((TextView) view.findViewById(R.id.day_date)).setText(df);
        ((TextView) view.findViewById(R.id.day_temp)).setText(foreCasts.get(i).getMax_temp());
        ((TextView) view.findViewById(R.id.night_temp)).setText(foreCasts.get(i).getMin_temp());
        ((TextView) view.findViewById(R.id.day_phrase)).setText(foreCasts.get(i).getDay_phrase());
        ((TextView) view.findViewById(R.id.night_phrase)).setText(foreCasts.get(i).getNight_phrase());
        ((ImageView) view.findViewById(R.id.day_icon)).setImageResource(get_day_draw(foreCasts.get(i)));
        ((ImageView) view.findViewById(R.id.night_icon)).setImageResource(get_night_draw(foreCasts.get(i)));
